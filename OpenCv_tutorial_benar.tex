...
\end{figure}
\\- Fungsi untuk mendeteksi wajah, menggunakan fungsi \textbf{detectMultiScale} dengan memproses fitur haarcascade
\begin{figure}[h!]
    \centering
...
\begin{figure}[h!]
    ...
    \includegraphics[width=0.33\linewidth]{images/HASIL 2.PNG}
