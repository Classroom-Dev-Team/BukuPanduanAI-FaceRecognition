...
\begin{figure}[h!]
    ...
    \caption{Memasukan library openCV}
\end{figure}
\\- Memasukan video, \textbf{cv2.VideoCapture} merupakan fungsi untuk membaca video yang akan dijadikan \emph{sample} dan bisa juga untuk menampilkan frame kamera yang terkoneksi.
\begin{figure}[h!]
    \centering
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.35\linewidth]{images/HASIL 1.PNG}
    \includegraphics[width=0.35\linewidth]{images/HASIL 2.PNG}
